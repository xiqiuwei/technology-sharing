...
import management.auth.common.exception.CommonException;
...
public class RSAUtils {
     ...
     * @Description 公钥加密明文
     */
    public String publicKeyEncrypt(String string) throws Exception {
     ...
     * @Description 私钥解密密文
     */
    public String privateKeyDecrypt(String encrypt) throws Exception {
    ...
    public RSAPublicKey getPublicKey() throws IOException, NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        String pubKey = this.readFile(inputStream);
    ...
    public RSAPrivateKey getPrivateKey() throws IOException, NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        String priKey = this.readFile(inputStream);

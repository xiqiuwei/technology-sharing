...
public class MyThreadPool {
    ...
    public Object submit(Callable<?> callable) throws ExecutionException, InterruptedException {
        Future<?> submit = userDefinedPool.submit(callable);
        return submit.get();
    }

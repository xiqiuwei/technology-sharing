package com.management.warehouse.core.config;
...
/**
 * @Author xiqiuwei
 * @Date Created in 17:49 2019/7/10
 * @Description
 * @Modified By:
 */
public class MpGenerator {
    //生成文件所在项目路径
    private static String baseProjectPath = "D:\\workspace\\management\\management-warehouse-core";
    //基本包名
    private static String basePackage = "com.management.warehouse.core";
    //作者
    private static String authorName = "xiqiuwei";
    //要生成的表名
    private static String[] tables = {"tb_category","tb_goods","tb_stock","tb_turnover","tb_user"};
    //table前缀
    private static String prefix = "tb_";
    //数据库配置四要素
    private static String driverName = "com.mysql.jdbc.Driver";
    private static String url = "jdbc:mysql://47.101.138.105:3306/repository?useUnicode=true&characterEncoding=utf-8";
